...
//  function createPaginMarkup(pages, page) {
//   if (pages < 2) {
//     return '';
//   }
...
//   document.querySelector('.pagination li').innerHTML = str;
//   return str;
// }

export default function createPaginMarkup(data) {
  document.querySelector('.pagination li').innerHTML = (data.total_pages, data.page);
}